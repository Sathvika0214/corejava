...
emails.add("sathvika@example.com");
emails.add("sony.sonuam@example.me.org");
//invalid email addresses
emails.add("anvika.example.com");
emails.add("myname is..pavanxample.com");
emails.add("abcdefg123 example.com");
